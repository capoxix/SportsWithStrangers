...
g1 = Event.create!(
  ...
  date_time: DateTime.new(2018,month,26,15),
...
g2 = Event.create!(
  ...
  date_time: DateTime.new(2018,month,28,16),
...
g3 = Event.create!(
  ...
  date_time: DateTime.new(2018,month,29,19),
...
g4 = Event.create!(
  ...
  city_id: sf.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,23,15),
  address: "Helen Wills Park",
  country: "USA",
...
g5 = Event.create!(
  ...
  category_id: soccer.id,
  date_time: DateTime.new(2018,month,25,15),
...
g6 = Event.create!(
  ...
  city_id: oakland.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,26,16),
...
g7 = Event.create!(
  ...
  city_id: oakland.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,27,16),
  address: "JAMTOWN, 31 4th st",
  country: "USA",
  description: "Looking to play full court games.",
  num_of_members: 10
...
g9 = Event.create!(
  ...
  city_id: la.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,29,16),
  address: "John Wooden Center, 221 Westwood Plaza",
  country: "USA",
  description: "Looking to play full court games.",
  num_of_members: 10
...
k3 = Event.create!(
  ...
  city_id: la.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,30,16),
  address: "1111 S Figueroa St",
  country: "USA",
...
l1 =   Event.create!(
  ...
  city_id: la.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,26,13),
  address: "1111 S Figueroa St",
  country: "USA",
...
l2 = Event.create!(
  ...
  city_id: la.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,28,12),
  address: "1111 S Figueroa St",
  country: "USA",
  description: "Looking to play with possible future teammates.",
  num_of_members: 10
...
l3 = Event.create!(
  ...
  city_id: la.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,27,12),
  address: "1111 S Figueroa St",
  country: "USA",
  description: "Looking to play 1v1 to 50 points.",
  num_of_members: 2
...
l4 = Event.create!(
  ...
  city_id: la.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,29,12),
  address: "1111 S Figueroa St",
  country: "USA",
...
l5 = Event.create!(
  ...
  city_id: la.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,30,12),
  address: "1111 S Figueroa St",
  country: "USA",
  description: "Looking to play full court games.",
  num_of_members: 10
...
c2 = Event.create!(
  ...
  city_id: oakland.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,28,20),
  address: "7000 Coliseum Way",
  country: "USA",
  description: "Looking to play 3v3 half court games.",
  num_of_members: 6
...
c4 = Event.create!(
  ...
  city_id: oakland.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,30,20),
  address: "7000 Coliseum Way",
  country: "USA",
...
klay2 = Event.create!(
  ...
  city_id: oakland.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,26,20),
  address: "7000 Coliseum Way",
  country: "USA",
...
klay3 = Event.create!(
  ...
  city_id: oakland.id,
  category_id: bball.id,
  date_time: DateTime.new(2018,month,27,20),
  address: "7000 Coliseum Way",
  country: "USA",
...
r3 = Event.create!(
  ...
  city_id: sf.id,
  category_id: tennis.id,
  date_time: DateTime.new(2018,month,28,13),
  address: "Golden Gate Park Tennis Courts",
  country: "USA",
  description: "Looking to play singles match.",
  num_of_members: 2
...
s1 = Event.create!(
  ...
  city_id: london.id,
  category_id: tennis.id,
  date_time: DateTime.new(2018,month,28,15),
  address: "The All England Lawn Tennis Club",
  country: "UK",
  description: "Looking to play singles match.",
  num_of_members: 2
...
s3 = Event.create!(
  ...
  city_id: sf.id,
  category_id: tennis.id,
  date_time: DateTime.new(2018,month,30,18),
  address: "Golden Gate Park Tennis Courts",
  country: "USA",
  description: "Looking to play singles match.",
  num_of_members: 2
...
b2 = Event.create!(
  ...
  city_id: sf.id,
  category_id: soccer.id,
  date_time: DateTime.new(2018,month,27,21),
...
m2 = Event.create!(
  ...
  city_id: barcelona.id,
  category_id: soccer.id,
  date_time: DateTime.new(2018,month,29,15),
  address: "Aristides Maillol 08028",
  country: "Spain",
...
m4 = Event.create!(
  ...
  city_id: barcelona.id,
  category_id: soccer.id,
  date_time: DateTime.new(2018,month,27,15),
  address: "Aristides Maillol 08028",
  country: "Spain",
